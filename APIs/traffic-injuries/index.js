module.exports = function(app, express, bodyParser, path) {
    ...
    app.get(BASE_API_URL + '/traffic-injuries/loadInitialData', (req, res) => {
        ...
        console.log('Initial Contacts Loaded:' + JSON.stringify(initialTrafficInjuries, null, 2));
    });
    ...
    // GET loadInitialData
    app.get(BASE_API_URL + '/traffic-injuries/loadInitialDataOld', (req, res) => {
    ...
    app.get(BASE_API_URL + '/traffic-injuries/:auto_com/:year', (req, res) => {
        ...
        var filteredTrafficInjury = trafficInjuries.filter(c => {
            return c.auto_com == auto_com && c.year == year;
        });
