<script>
    ...
    async function loadInitialDataNatalityStats() {
        const res = await fetch("https://sos1920-01.herokuapp.com/api/v2/natality-stats/loadInitialData", {
            method: "GET"
        }).then(function (res) {
            highchartsGraphG1();
    ...
    async function deleteAllNatalityStats() {
        const res = await fetch("https://sos1920-01.herokuapp.com/api/v2/natality-stats", {
            method: "DELETE"
        }).then(function (res) {
            if (res.status == 404) {
                infoAlertStatus = res.status + " - " + res.statusText;
    ...
    async function highchartsGraphG1() {
        ...
        const data = await fetch("https://sos1920-01.herokuapp.com/api/v2/natality-stats");
        ...
        <div class="col-4">
            <div class="list-group" id="list-tab" role="tablist">
                ...
                <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list"
                    href="#list-01" role="tab" aria-controls="home">Integración con Grupo 1 <br>(Natality-stats)</a>
        ...
        <div class="col-8">
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="list-01" role="tabpanel" aria-labelledby="list-home-list">
                    ...
                    <p><Button color="success" on:click="{loadInitialDataNatalityStats}">Cargar Datos Iniciales</Button></p>
                    <p><Button color="danger" on:click="{deleteAllNatalityStats}">Elimina Todos los Recursos</Button></p>
